...
const ChatHome = ({
  ...
  return (
    <div className="h-full w-full flex flex-col justify-evenly sm:justify-between">
      <h1 className="max-[520px]:text-3xl text-4xl xl:text-[3.5rem] sm:leading-[1] w-3/4 max-[420px]:w-full max-[420px]:text-center md:w-[60%] my-[3rem] flex flex-col justify-between text-[#D18F5F]">
